...
\restrict HJmc6Fz2d3wVw6Mpa3sEfY5hghnpl0FCBVkFT523TaTzoRWTMFPvNpglysbeyft
...
ALTER TABLE IF EXISTS ONLY public.wallets DROP CONSTRAINT IF EXISTS wallets_landlord_id_fkey;
ALTER TABLE IF EXISTS ONLY public.units DROP CONSTRAINT IF EXISTS units_property_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tenancies DROP CONSTRAINT IF EXISTS tenancies_unit_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tenancies DROP CONSTRAINT IF EXISTS tenancies_tenant_id_fkey;
ALTER TABLE IF EXISTS ONLY public.properties DROP CONSTRAINT IF EXISTS properties_landlord_id_fkey;
ALTER TABLE IF EXISTS ONLY public.payouts DROP CONSTRAINT IF EXISTS payouts_landlord_id_fkey;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_tenancy_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ledger_entries DROP CONSTRAINT IF EXISTS ledger_entries_tenancy_fkey;
ALTER TABLE IF EXISTS ONLY public.ledger_entries DROP CONSTRAINT IF EXISTS ledger_entries_property_id_fkey;
ALTER TABLE IF EXISTS ONLY public.wallets DROP CONSTRAINT IF EXISTS fk_wallets_landlord;
ALTER TABLE IF EXISTS ONLY public.wallets DROP CONSTRAINT IF EXISTS fk_wallet_property;
ALTER TABLE IF EXISTS ONLY public.units DROP CONSTRAINT IF EXISTS fk_units_property;
ALTER TABLE IF EXISTS ONLY public.tenancies DROP CONSTRAINT IF EXISTS fk_tenancies_unit;
ALTER TABLE IF EXISTS ONLY public.tenancies DROP CONSTRAINT IF EXISTS fk_tenancies_tenant;
ALTER TABLE IF EXISTS ONLY public.dashboard_snapshots DROP CONSTRAINT IF EXISTS fk_snapshot_property;
ALTER TABLE IF EXISTS ONLY public.properties DROP CONSTRAINT IF EXISTS fk_properties_landlord;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS fk_payments_tenancy;
ALTER TABLE IF EXISTS ONLY public.ledger_entries DROP CONSTRAINT IF EXISTS fk_ledger_tenancy;
ALTER TABLE IF EXISTS ONLY public.ledger_entries DROP CONSTRAINT IF EXISTS fk_ledger_property;
...
DROP INDEX IF EXISTS public.uq_active_tenancy_per_unit;
DROP INDEX IF EXISTS public.idx_wallets_landlord;
DROP INDEX IF EXISTS public.idx_users_email_unique;
DROP INDEX IF EXISTS public.idx_units_reference_number_unique;
DROP INDEX IF EXISTS public.idx_units_property_id;
DROP INDEX IF EXISTS public.idx_units_property;
DROP INDEX IF EXISTS public.idx_units_account_number_unique;
DROP INDEX IF EXISTS public.idx_tenancies_unit_id;
DROP INDEX IF EXISTS public.idx_tenancies_unit;
DROP INDEX IF EXISTS public.idx_properties_landlord;
DROP INDEX IF EXISTS public.idx_payments_tx_code_unique;
DROP INDEX IF EXISTS public.idx_payments_tenancy_id;
DROP INDEX IF EXISTS public.idx_payments_tenancy;
DROP INDEX IF EXISTS public.idx_payments_created_at;
DROP INDEX IF EXISTS public.idx_mpesa_tx_code_unique;
DROP INDEX IF EXISTS public.idx_mpesa_created_at;
DROP INDEX IF EXISTS public.idx_ledger_tenancy_id;
DROP INDEX IF EXISTS public.idx_ledger_tenancy_balance;
DROP INDEX IF EXISTS public.idx_ledger_entries_property;
...
ALTER TABLE IF EXISTS ONLY public.units DROP CONSTRAINT IF EXISTS units_property_id_unit_number_key;
ALTER TABLE IF EXISTS ONLY public.units DROP CONSTRAINT IF EXISTS units_pkey;
ALTER TABLE IF EXISTS ONLY public.units DROP CONSTRAINT IF EXISTS units_account_number_key;
ALTER TABLE IF EXISTS ONLY public.units DROP CONSTRAINT IF EXISTS unique_unit_per_property;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS unique_transaction_code;
ALTER TABLE IF EXISTS ONLY public.units DROP CONSTRAINT IF EXISTS unique_reference_number;
ALTER TABLE IF EXISTS ONLY public.wallets DROP CONSTRAINT IF EXISTS unique_property_wallet;
ALTER TABLE IF EXISTS ONLY public.dashboard_snapshots DROP CONSTRAINT IF EXISTS unique_property_month;
ALTER TABLE IF EXISTS ONLY public.properties DROP CONSTRAINT IF EXISTS unique_account_prefix;
ALTER TABLE IF EXISTS ONLY public.units DROP CONSTRAINT IF EXISTS uktah7k94bauuojgt37fwjf0cch;
...
ALTER TABLE IF EXISTS ONLY public.properties DROP CONSTRAINT IF EXISTS properties_account_prefix_key;
ALTER TABLE IF EXISTS ONLY public.payouts DROP CONSTRAINT IF EXISTS payouts_pkey;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_pkey;
ALTER TABLE IF EXISTS ONLY public.mpesa_transactions DROP CONSTRAINT IF EXISTS mpesa_transactions_transaction_code_key;
ALTER TABLE IF EXISTS ONLY public.mpesa_transactions DROP CONSTRAINT IF EXISTS mpesa_transactions_pkey;
ALTER TABLE IF EXISTS ONLY public.ledger_entries DROP CONSTRAINT IF EXISTS ledger_entries_pkey;
ALTER TABLE IF EXISTS ONLY public.flyway_schema_history DROP CONSTRAINT IF EXISTS flyway_schema_history_pk;
ALTER TABLE IF EXISTS ONLY public.dashboard_snapshots DROP CONSTRAINT IF EXISTS dashboard_snapshots_pkey;
ALTER TABLE IF EXISTS ONLY public.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_pkey;
DROP TABLE IF EXISTS public.wallets;
DROP TABLE IF EXISTS public.users;
DROP TABLE IF EXISTS public.tenants;
DROP VIEW IF EXISTS public.tenancy_balances;
DROP TABLE IF EXISTS public.sms_logs;
DROP VIEW IF EXISTS public.property_summary;
...
DROP FUNCTION IF EXISTS public.record_payment_ledger_entry();
DROP FUNCTION IF EXISTS public.process_payment(p_tenancy_id uuid, p_amount numeric, p_reference text);
DROP FUNCTION IF EXISTS public.prevent_ledger_update();
DROP FUNCTION IF EXISTS public.prevent_ledger_delete();
DROP FUNCTION IF EXISTS public.create_wallet_for_landlord();
...
DROP TYPE IF EXISTS public.ledger_category;
...
--
-- Name: ledger_category; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: charge_monthly_rent(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: create_wallet_for_landlord(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: process_payment(uuid, numeric, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: record_payment_ledger_entry(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: tenancy_balances; Type: VIEW; Schema: public; Owner: -
--
...
81490d9f-72e7-4c2d-ad20-b938de47a12e	accc69fd-93b1-4739-940a-0483fc07fa09	CREDIT	\N	2000.00	\N	2026-03-08 15:31:15.145467	\N	TESTPAY012
...
bcd6dce6-46d2-4de6-a787-091ddf78efdc	accc69fd-93b1-4739-940a-0483fc07fa09	CREDIT	\N	2000.00	\N	2026-03-08 15:36:06.850222	\N	TESTPAY013
...
8e9fb4d0-0b1f-4b95-807a-9d20075b8c4f	991ef00c-a4cd-43de-972d-09064693e803	2000.00	MPESA	TESTPAY012	2026-03-08 15:31:15.145467	2026-03-08 15:31:15.145467	\N	\N
aef046d4-3cd7-45e7-8ddb-6d46fcf8ea1b	991ef00c-a4cd-43de-972d-09064693e803	2000.00	MPESA	TESTPAY013	2026-03-08 15:36:06.850222	2026-03-08 15:36:06.850222	\N	\N
d5fdf070-cf23-4ebc-ac86-419333defeec	991ef00c-a4cd-43de-972d-09064693e803	2000.00	MPESA	TESTPAY015	2026-03-08 16:47:55.482869	2026-03-08 16:47:55.482869	\N	\N
\.
...
--
-- Data for Name: tenancies; Type: TABLE DATA; Schema: public; Owner: -
--
...
c20e89f4-6af2-4eb3-8753-d62dc9407544	Issa Landlord	issa@gmail.com	254700000001	Issa	LANDLORD	t	2026-02-27 16:11:48.599007
8dca0662-6bdf-40e5-86f8-f6c20b76648d	Test Landlord	test@gmail.com	254700000002	test	LANDLORD	t	2026-02-27 16:15:21.581402
...
ace642e7-8068-4f21-9b4a-7ea89bceafab	c20e89f4-6af2-4eb3-8753-d62dc9407544	25000.00	f	t	2026-02-27 16:16:07.473028	\N
...
--
-- Name: mpesa_transactions mpesa_transactions_transaction_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: properties properties_account_prefix_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: units uktah7k94bauuojgt37fwjf0cch; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: properties unique_account_prefix; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: dashboard_snapshots unique_property_month; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: wallets unique_property_wallet; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: units unique_reference_number; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payments unique_transaction_code; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: units unique_unit_per_property; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: units units_account_number_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_ledger_entries_property; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ledger_tenancy_balance; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ledger_tenancy_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mpesa_created_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mpesa_tx_code_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_tenancy; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_tenancy_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_tx_code_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tenancies_unit_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_units_account_number_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_units_reference_number_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_wallets_landlord; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_active_tenancy_per_unit; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ledger_entries trg_prevent_ledger_delete; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: ledger_entries trg_prevent_ledger_update; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: users trigger_create_wallet; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: payments trigger_payment_ledger; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: ledger_entries fk_ledger_property; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ledger_entries fk_ledger_tenancy; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payments fk_payments_tenancy; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: properties fk_properties_landlord; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: dashboard_snapshots fk_snapshot_property; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenancies fk_tenancies_tenant; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenancies fk_tenancies_unit; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: wallets fk_wallet_property; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: wallets fk_wallets_landlord; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ledger_entries ledger_entries_property_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ledger_entries ledger_entries_tenancy_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payouts payouts_landlord_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: wallets wallets_landlord_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict HJmc6Fz2d3wVw6Mpa3sEfY5hghnpl0FCBVkFT523TaTzoRWTMFPvNpglysbeyft
